...
#' b. Hvaða ríki er númer 39 í vigrinum state.name?
...
#'    meðalhæð í þýðinu sé jöfn 168. Hvaða t og p gildi fáum við?
...
#' fæddir eru árið 1962 eða síðar. Kallaðu það ks2
...
#' Þeir sem eru fæddir milli 1962 og 1990 og þá sem eru fæddir eftir 1990.
...
#' tölustaf dálksins pop í gapminder gögnunum fyrir árið 1957. Hvað er hlutfall
