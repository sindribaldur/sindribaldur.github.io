...
#' b. Hvaða ríki er númer 33 í vigrinum state.name?
...
#' fæddir eru árið 1968 eða síðar. Kallaðu það ks2
...
#' Þeir sem eru fæddir milli 1968 og 1990 og þá sem eru fæddir eftir 1990.
...
#' tölustaf dálksins pop í gapminder gögnunum fyrir árið 1987. Hvað er hlutfall
