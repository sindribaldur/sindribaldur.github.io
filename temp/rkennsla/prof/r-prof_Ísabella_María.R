...
#'    meðalhæð í þýðinu sé jöfn 161. Hvaða t og p gildi fáum við?
...
#' fæddir eru árið 1964 eða síðar. Kallaðu það ks2
...
#' Þeir sem eru fæddir milli 1964 og 1990 og þá sem eru fæddir eftir 1990.
...
#' tölustaf dálksins pop í gapminder gögnunum fyrir árið 1992. Hvað er hlutfall
