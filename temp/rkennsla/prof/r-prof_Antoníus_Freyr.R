...
#' b. Hvaða ríki er númer 31 í vigrinum state.name?
...
#'    meðalhæð í þýðinu sé jöfn 170. Hvaða t og p gildi fáum við?
...
#' fæddir eru árið 1961 eða síðar. Kallaðu það ks2
...
#' Þeir sem eru fæddir milli 1961 og 1990 og þá sem eru fæddir eftir 1990.
...
#' tölustaf dálksins pop í gapminder gögnunum fyrir árið 1997. Hvað er hlutfall
