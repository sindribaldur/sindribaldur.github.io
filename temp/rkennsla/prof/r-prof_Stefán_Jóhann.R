...
#' fæddir eru árið 1969 eða síðar. Kallaðu það ks2
...
#' Þeir sem eru fæddir milli 1969 og 1990 og þá sem eru fæddir eftir 1990.
...
#' tölustaf dálksins pop í gapminder gögnunum fyrir árið 1952. Hvað er hlutfall
