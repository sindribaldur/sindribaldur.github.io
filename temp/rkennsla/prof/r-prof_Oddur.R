...
#' b. Hvaða ríki er númer 40 í vigrinum state.name?
...
#' fæddir eru árið 1960 eða síðar. Kallaðu það ks2
...
#' Þeir sem eru fæddir milli 1960 og 1990 og þá sem eru fæddir eftir 1990.
